...
var I = { tooltip: "styles-module_tooltip__mnnfp", arrow: "styles-module_arrow__K0L3T", dark: "styles-module_dark__xNqje", light: "styles-module_light__Z6W-X", success: "styles-module_success__A2AKt", warning: "styles-module_warning__SCK0X", error: "styles-module_error__JvumD", info: "styles-module_info__BWdHW" };
var j = ({ forwardRef: t2, id: r2, className: n2, classNameArrow: s2, variant: u = "dark", anchorId: d, anchorSelect: p, place: v = "top", offset: m = 10, events: h2 = ["hover"], openOnClick: w2 = false, positionStrategy: b2 = "absolute", middlewares: S2, wrapper: E2, delayShow: _2 = 0, delayHide: A2 = 0, float: O2 = false, hidden: T2 = false, noArrow: L2 = false, clickable: R2 = false, closeOnEsc: j2 = false, closeOnScroll: B2 = false, closeOnResize: z2 = false, openEvents: D2, closeEvents: q, globalCloseEvents: H, imperativeModeOnly: M, style: W, position: P, afterShow: V, afterHide: F, content: K, contentWrapperRef: U, isOpen: X, defaultIsOpen: Y = false, setIsOpen: G, activeAnchor: Z, setActiveAnchor: J, border: Q, opacity: ee, arrowColor: te, role: oe = "tooltip" }) => {
  var le;
  const re = (0, import_react.useRef)(null), ne = (0, import_react.useRef)(null), ce = (0, import_react.useRef)(null), ie = (0, import_react.useRef)(null), se = (0, import_react.useRef)(null), [ae, ue] = (0, import_react.useState)(v), [de, pe] = (0, import_react.useState)({}), [ve, me] = (0, import_react.useState)({}), [fe, ye] = (0, import_react.useState)(false), [he, we] = (0, import_react.useState)(false), [be, Se] = (0, import_react.useState)(null), Ee = (0, import_react.useRef)(false), ge = (0, import_react.useRef)(null), { anchorRefs: _e, setActiveAnchor: Ae } = k(r2), Oe = (0, import_react.useRef)(false), [Te, ke] = (0, import_react.useState)([]), Le = (0, import_react.useRef)(false), Ce = w2 || h2.includes("click"), Re = Ce || (null == D2 ? void 0 : D2.click) || (null == D2 ? void 0 : D2.dblclick) || (null == D2 ? void 0 : D2.mousedown), xe = D2 ? { ...D2 } : { mouseenter: true, focus: true, click: false, dblclick: false, mousedown: false };
  !D2 && Ce && Object.assign(xe, { mouseenter: false, focus: false, click: true });
  const Ne = q ? { ...q } : { mouseleave: true, blur: true, click: false, dblclick: false, mouseup: false };
  !q && Ce && Object.assign(Ne, { mouseleave: false, blur: false });
  const $e = H ? { ...H } : { escape: j2 || false, scroll: B2 || false, resize: z2 || false, clickOutsideAnchor: Re || false };
  M && (Object.assign(xe, { mouseenter: false, focus: false, click: false, dblclick: false, mousedown: false }), Object.assign(Ne, { mouseleave: false, blur: false, click: false, dblclick: false, mouseup: false }), Object.assign($e, { escape: false, scroll: false, resize: false, clickOutsideAnchor: false })), C(() => (Le.current = true, () => {
    Le.current = false;
  }), []);
  const Ie = (e2) => {
    Le.current && (e2 && we(true), setTimeout(() => {
      Le.current && (null == G || G(e2), void 0 === X && ye(e2));
    }, 10));
  };
  (0, import_react.useEffect)(() => {
    ...
    if (fe !== Ee.current) if (se.current && clearTimeout(se.current), Ee.current = fe, fe) null == V || V();
    else {
      const e2 = ((e3) => {
  ...
  const je = (e2 = _2) => {
    ...
    if (!(null == o2 ? void 0 : o2.isConnected)) return J(null), void Ae({ current: null });
    _2 ? je() : Ie(true), J(o2), Ae({ current: o2 }), ie.current && clearTimeout(ie.current);
  }, De = () => {
    R2 ? Be(A2 || 100) : A2 ? Be() : Ie(false), ce.current && clearTimeout(ce.current);
  }, qe = ({ x: e2, y: t3 }) => {
    var o2;
    const l2 = { getBoundingClientRect: () => ({ x: e2, y: t3, width: 0, height: 0, top: t3, left: e2, right: e2, bottom: t3 }) };
    N({ place: null !== (o2 = null == be ? void 0 : be.place) && void 0 !== o2 ? o2 : v, offset: m, elementReference: l2, tooltipReference: re.current, tooltipArrowReference: ne.current, strategy: b2, middlewares: S2, border: Q }).then((e3) => {
      Object.keys(e3.tooltipStyles).length && pe(e3.tooltipStyles), Object.keys(e3.tooltipArrowStyles).length && me(e3.tooltipArrowStyles), ue(e3.place);
    });
  }, He = (e2) => {
    if (!e2) return;
    ...
    if (!fe) return;
    const o2 = e2.target;
    if (null === (t3 = re.current) || void 0 === t3 ? void 0 : t3.contains(o2)) return;
    [document.querySelector(`[id='${d}']`), ...Te].some((e3) => null == e3 ? void 0 : e3.contains(o2)) || (Ie(false), ce.current && clearTimeout(ce.current));
  }, We = g(ze, 50, true), Pe = g(De, 50, true), Ve = (e2) => {
    Pe.cancel(), We(e2);
  }, Fe = () => {
    We.cancel(), Pe();
  }, Ke = (0, import_react.useCallback)(() => {
    var e2, t3;
    const o2 = null !== (e2 = null == be ? void 0 : be.position) && void 0 !== e2 ? e2 : P;
    o2 ? qe(o2) : O2 ? ge.current && qe(ge.current) : (null == Z ? void 0 : Z.isConnected) && N({ place: null !== (t3 = null == be ? void 0 : be.place) && void 0 !== t3 ? t3 : v, offset: m, elementReference: Z, tooltipReference: re.current, tooltipArrowReference: ne.current, strategy: b2, middlewares: S2, border: Q }).then((e3) => {
      Le.current && (Object.keys(e3.tooltipStyles).length && pe(e3.tooltipStyles), Object.keys(e3.tooltipArrowStyles).length && me(e3.tooltipArrowStyles), ue(e3.place));
    });
  }, [fe, Z, K, W, v, null == be ? void 0 : be.place, m, b2, P, null == be ? void 0 : be.position, O2]);
  (0, import_react.useEffect)(() => {
    var e2, t3;
    const o2 = new Set(_e);
    Te.forEach((e3) => {
    ...
    const r3 = () => {
      Ie(false);
    }, n3 = x(Z), c2 = x(re.current);
    $e.scroll && (window.addEventListener("scroll", r3), null == n3 || n3.addEventListener("scroll", r3), null == c2 || c2.addEventListener("scroll", r3));
    let i2 = null;
    $e.resize ? window.addEventListener("resize", r3) : Z && re.current && (i2 = autoUpdate(Z, re.current, Ke, { ancestorResize: true, elementResize: true, layoutShift: true }));
    const s3 = (e3) => {
      "Escape" === e3.key && Ie(false);
    };
    $e.escape && window.addEventListener("keydown", s3), $e.clickOutsideAnchor && window.addEventListener("click", Me);
    const a2 = [], u2 = (e3) => {
      fe && (null == e3 ? void 0 : e3.target) === Z || ze(e3);
    }, p2 = (e3) => {
      fe && (null == e3 ? void 0 : e3.target) === Z && De();
    ...
    }), O2 && a2.push({ event: "pointermove", listener: He });
    const y2 = () => {
      Oe.current = true;
    }, h3 = () => {
      Oe.current = false, De();
    };
    return R2 && !Re && (null === (e2 = re.current) || void 0 === e2 || e2.addEventListener("mouseenter", y2), null === (t3 = re.current) || void 0 === t3 || t3.addEventListener("mouseleave", h3)), a2.forEach(({ event: e3, listener: t4 }) => {
      o2.forEach((o3) => {
        var l3;
      ...
      var e3, t4;
      $e.scroll && (window.removeEventListener("scroll", r3), null == n3 || n3.removeEventListener("scroll", r3), null == c2 || c2.removeEventListener("scroll", r3)), $e.resize ? window.removeEventListener("resize", r3) : null == i2 || i2(), $e.clickOutsideAnchor && window.removeEventListener("click", Me), $e.escape && window.removeEventListener("keydown", s3), R2 && !Re && (null === (e3 = re.current) || void 0 === e3 || e3.removeEventListener("mouseenter", y2), null === (t4 = re.current) || void 0 === t4 || t4.removeEventListener("mouseleave", h3)), a2.forEach(({ event: e4, listener: t5 }) => {
        o2.forEach((o3) => {
          var l3;
  ...
  }, [Z, Ke, he, _e, Te, D2, q, H, Ce]), (0, import_react.useEffect)(() => {
    var e2, t3;
    ...
    const l2 = new MutationObserver((e3) => {
      ...
      e3.forEach((e4) => {
        ...
        if ("childList" === e4.type) {
          if (Z) {
            ...
            t5.some((e5) => {
              var t6;
              return !!(null === (t6 = null == e5 ? void 0 : e5.contains) || void 0 === t6 ? void 0 : t6.call(e5, Z)) && (we(false), Ie(false), J(null), ce.current && clearTimeout(ce.current), ie.current && clearTimeout(ie.current), true);
            });
          }
          if (o2) try {
      ...
      }), (t4.length || l3.length) && ke((e4) => [...e4.filter((e5) => !l3.includes(e5)), ...t4]);
    });
  ...
  }, [r2, p, null == be ? void 0 : be.anchorSelect, Z]), (0, import_react.useEffect)(() => {
    Ke();
    ...
    Z && o2.includes(Z) || J(null !== (e2 = Te[0]) && void 0 !== e2 ? e2 : t3);
  }, [d, Te, Z]), (0, import_react.useEffect)(() => (Y && Ie(true), () => {
    ce.current && clearTimeout(ce.current), ie.current && clearTimeout(ie.current);
  }), []), (0, import_react.useEffect)(() => {
    var e2;
    let t3 = null !== (e2 = null == be ? void 0 : be.anchorSelect) && void 0 !== e2 ? e2 : p;
    if (!t3 && r2 && (t3 = `[data-tooltip-id='${r2}']`), t3) try {
      const e3 = Array.from(document.querySelectorAll(t3));
      ke(e3);
    } catch (e3) {
      ke([]);
    }
  }, [r2, p, null == be ? void 0 : be.anchorSelect]);
  const Ue = null !== (le = null == be ? void 0 : be.content) && void 0 !== le ? le : K, Xe = fe && Object.keys(de).length > 0;
  ...
  }, activeAnchor: Z, place: ae, isOpen: Boolean(he && !T2 && Ue && Xe) })), he && !T2 && Ue ? import_react.default.createElement(E2, { id: r2, role: oe, className: (0, import_classnames.default)("react-tooltip", $.tooltip, I.tooltip, I[u], n2, `react-tooltip__place-${ae}`, $[Xe ? "show" : "closing"], Xe ? "react-tooltip__show" : "react-tooltip__closing", "fixed" === b2 && $.fixed, R2 && $.clickable), onTransitionEnd: (e2) => {
    se.current && clearTimeout(se.current), fe || "opacity" !== e2.propertyName || (we(false), Se(null), null == F || F());
  }, style: { ...W, ...de, opacity: void 0 !== ee && Xe ? ee : void 0 }, ref: re }, Ue, import_react.default.createElement(E2, { className: (0, import_classnames.default)("react-tooltip-arrow", $.arrow, I.arrow, s2, L2 && $.noArrow), style: { ...ve, background: te ? `linear-gradient(to right bottom, transparent 50%, ${te} 50%)` : void 0 }, ref: ne })) : null;
};
...
var D = import_react.default.forwardRef(({ id: t2, anchorId: l2, anchorSelect: r2, content: n2, html: s2, render: a2, className: u, classNameArrow: d, variant: p = "dark", place: v = "top", offset: m = 10, wrapper: f = "div", children: h2 = null, events: w2 = ["hover"], openOnClick: b2 = false, positionStrategy: S2 = "absolute", middlewares: E2, delayShow: g2 = 0, delayHide: _2 = 0, float: A2 = false, hidden: O2 = false, noArrow: T2 = false, clickable: L2 = false, closeOnEsc: C2 = false, closeOnScroll: R2 = false, closeOnResize: x2 = false, openEvents: N2, closeEvents: $2, globalCloseEvents: I2, imperativeModeOnly: D2 = false, style: q, position: H, isOpen: M, defaultIsOpen: W = false, disableStyleInjection: P = false, border: V, opacity: F, arrowColor: K, setIsOpen: U, afterShow: X, afterHide: Y, role: G = "tooltip" }, Z) => {
  const [J, Q] = (0, import_react.useState)(n2), [ee, te] = (0, import_react.useState)(s2), [oe, le] = (0, import_react.useState)(v), [re, ne] = (0, import_react.useState)(p), [ce, ie] = (0, import_react.useState)(m), [se, ae] = (0, import_react.useState)(g2), [ue, de] = (0, import_react.useState)(_2), [pe, ve] = (0, import_react.useState)(A2), [me, fe] = (0, import_react.useState)(O2), [ye, he] = (0, import_react.useState)(f), [we, be] = (0, import_react.useState)(w2), [Se, Ee] = (0, import_react.useState)(S2), [ge, _e] = (0, import_react.useState)(null), [Ae, Oe] = (0, import_react.useState)(null), Te = (0, import_react.useRef)(P), { anchorRefs: ke, activeAnchor: Le } = k(t2), Ce = (e2) => null == e2 ? void 0 : e2.getAttributeNames().reduce((t3, o2) => {
    var l3;
  ...
  (0, import_react.useEffect)(() => {
    ...
    const o2 = new Set(ke);
    let n3 = r2;
    if (!n3 && t2 && (n3 = `[data-tooltip-id='${t2}']`), n3) try {
    ...
    if (c2 && o2.add({ current: c2 }), !o2.size) return () => null;
    const i2 = null !== (e2 = null != Ae ? Ae : c2) && void 0 !== e2 ? e2 : Le.current, s3 = new MutationObserver((e3) => {
      e3.forEach((e4) => {
        var t3;
        if (!i2 || "attributes" !== e4.type || !(null === (t3 = e4.attributeName) || void 0 === t3 ? void 0 : t3.startsWith("data-tooltip-"))) return;
        const o3 = Ce(i2);
        Re(o3);
      });
  ...
  }, [ke, Le, Ae, l2, r2]), (0, import_react.useEffect)(() => {
    (null == q ? void 0 : q.border) && console.warn("[react-tooltip] Do not set `style.border`. Use `border` prop instead."), V && !z("border", `${V}`) && console.warn(`[react-tooltip] "${V}" is not a valid \`border\`.`), (null == q ? void 0 : q.opacity) && console.warn("[react-tooltip] Do not set `style.opacity`. Use `opacity` prop instead."), F && !z("opacity", `${F}`) && console.warn(`[react-tooltip] "${F}" is not a valid \`opacity\`.`);
  }, []);
  let xe = h2;
  const Ne = (0, import_react.useRef)(null);
  if (a2) {
    const t3 = a2({ content: null != J ? J : null, activeAnchor: Ae });
    xe = t3 ? import_react.default.createElement("div", { ref: Ne, className: "react-tooltip-content-wrapper" }, t3) : null;
  } else J && (xe = J);
  ee && (xe = import_react.default.createElement(B, { content: ee }));
  const $e = { forwardRef: Z, id: t2, anchorId: l2, anchorSelect: r2, className: (0, import_classnames.default)(u, ge), classNameArrow: d, content: xe, contentWrapperRef: Ne, place: oe, variant: re, offset: ce, wrapper: ye, events: we, openOnClick: b2, positionStrategy: Se, middlewares: E2, delayShow: se, delayHide: ue, float: pe, hidden: me, noArrow: T2, clickable: L2, closeOnEsc: C2, closeOnScroll: R2, closeOnResize: x2, openEvents: N2, closeEvents: $2, globalCloseEvents: I2, imperativeModeOnly: D2, style: q, position: H, isOpen: M, defaultIsOpen: W, border: V, opacity: F, arrowColor: K, setIsOpen: U, afterShow: X, afterHide: Y, activeAnchor: Ae, setActiveAnchor: (e2) => Oe(e2), role: G };
  return import_react.default.createElement(j, { ...$e });
});
