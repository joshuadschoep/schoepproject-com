...
export const TIMELINE_ITEMS = [
  {
    ...
    tasks: [
      "Led front-end team to upgrade Woodridge's internal timekeeping and invoicing webapp from PHP running in-house to React 18 on AWS",
  ...
  },
  {
    ...
    location: 'Denver, Colorado',
    tasks: [
      'Contracted with a large home insurance company to fully modernize their AR payments from a .NET stack to Go microservices in 12 months.',
